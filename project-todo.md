...
#### 작업 목록
- [ ] **CMS-037**: Admin 페이지 사용자 가이드 작성
  - [ ] AdminPortfolio 가이드 (프로젝트 관리)
  - [ ] AdminLab 가이드 (바운티 관리)
  - [ ] AdminTeam 가이드 (팀원 관리)
  - [ ] AdminBlogCategories 가이드 (카테고리 관리)
  - [ ] AdminTags 가이드 (태그 관리)
  - [ ] AdminUsers 가이드 (관리자 계정 관리)

- [ ] **CMS-038**: API 문서 작성
  - [ ] useProjects 훅 API 문서
  - [ ] useRoadmapItems 훅 API 문서
  - [ ] usePortfolioItems 훅 API 문서
  - [ ] useLabItems 훅 API 문서
  - [ ] useTeamMembers 훅 API 문서
  - [ ] useBlogCategories 훅 API 문서
  - [ ] useTags 훅 API 문서

- [ ] **CMS-039**: E2E 테스트 작성
  - [ ] AdminPortfolio 테스트 (32개)
  - [ ] AdminLab 테스트 (28개)
  - [ ] AdminTeam 테스트 (28개)
  - [ ] AdminBlogCategories 테스트 (24개)
  - [ ] AdminTags 테스트 (24개)
  - [ ] AdminUsers 테스트 (18개)
  - **예상 총 테스트**: 154개

- [ ] **CMS-040**: 프로덕션 배포
  - [ ] Supabase 마이그레이션 적용 (9개 파일)
  - [ ] Vercel 환경 변수 설정
  - [ ] 빌드 검증 (0 에러, 0 경고)
  - [ ] Admin 페이지 접근 권한 테스트
  - [ ] RBAC 정책 검증
