...
## 🚀 사이트 재구조화 요구사항 (Sprint 2-4)

### Sprint 2: 프로젝트 페이지 통합

#### US-020: 프로젝트 허브 접근
**As a** 방문자
**I want to** 프로젝트 허브에서 모든 프로젝트 정보를 한눈에 볼 수 있기를
**So that** 진행중/출시/실험 프로젝트를 쉽게 탐색할 수 있다

**수용 기준**:
- [ ] /projects 페이지에서 4개 탭 전환 (진행중/출시됨/실험중/로드맵)
- [ ] URL 쿼리 파라미터 동기화 (?tab=in-progress)
- [ ] 프로젝트 통계 표시 (전체, 상태별 개수)
- [ ] 반응형 레이아웃

#### US-021: 프로젝트 진척률 확인
**As a** 방문자
**I want to** 프로젝트 카드에서 진척률을 확인할 수 있기를
...
#### US-022: 이야기 허브 접근
**As a** 방문자
**I want to** 이야기 허브에서 블로그, 뉴스레터, Changelog를 볼 수 있기를
**So that** 회사의 다양한 콘텐츠를 탐색할 수 있다

**수용 기준**:
- [ ] /stories 페이지에서 4개 섹션 미리보기 (블로그/뉴스레터/Changelog/공지사항)
- [ ] 각 섹션 "더 보기" 링크 동작
- [ ] 반응형 2x2 그리드

#### US-023: Changelog 확인
**As a** 방문자
**I want to** Changelog 페이지에서 서비스 업데이트 내역을 볼 수 있기를
**So that** 서비스 변경사항을 추적할 수 있다

**수용 기준**:
- [ ] /stories/changelog 접근 가능
- [ ] 버전별 변경사항 목록 (feature/fix/breaking)
- [ ] 프로젝트별 필터링

#### US-024: 뉴스레터 아카이브
**As a** 방문자
**I want to** 발송된 뉴스레터를 웹에서 볼 수 있기를
**So that** 과거 뉴스레터 내용을 확인할 수 있다

**수용 기준**:
- [ ] /stories/newsletter 접근 가능
- [ ] 뉴스레터 목록 표시 (제목, 발송일, 미리보기)
- [ ] 상세 페이지 (/stories/newsletter/:id)

#### US-025: 함께하기 허브 접근
**As a** 방문자
**I want to** 함께하기 허브에서 협업 방법을 찾을 수 있기를
**So that** 프로젝트 문의, 채용, 커뮤니티에 참여할 수 있다

**수용 기준**:
- [ ] /connect 페이지에서 3개 섹션 표시 (문의/채용/커뮤니티)
- [ ] 각 섹션 카드 클릭 시 해당 페이지 이동

### Sprint 4: GitHub 연동 & 실시간 동기화

#### US-026: GitHub 정보 표시
**As a** 방문자
**I want to** 프로젝트 카드에서 GitHub 정보를 볼 수 있기를
**So that** 프로젝트 활동성을 파악할 수 있다
...
#### US-027: 자동 Changelog 업데이트
**As a** 관리자
**I want to** GitHub 릴리즈 시 Changelog가 자동 업데이트되기를
**So that** 수동 업데이트 없이 변경사항을 공개할 수 있다

**수용 기준**:
- [ ] GitHub Release 감지
- [ ] changelog_entries 테이블 자동 추가
- [ ] 관리자 알림 (선택적)
